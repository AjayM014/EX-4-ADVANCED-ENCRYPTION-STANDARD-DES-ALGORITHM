...
## ALGORITHM:
Choose a large prime number p and an elliptic curve defined by the equation y^2 =x^3+ ax +b
mod p along with a base point G on the curve. Alice and Bob choose private keys. Compute public
keys: public_key = private_key * G (point multiplication). Exchange public keys. Compute the shared
secret: shared_secret = private_key * public_key_received.
## PROGRAM:
```
#include <stdio.h>
...
```
## OUTPUT:
![Screenshot 2024-11-11 090005](https://github.com/user-attachments/assets/7b6079b6-ceb7-414c-9b5f-03394b647dcb)



## RESULT:
The program for Elliptic Curve Cryptography (ECC) was executed successfully, and both Alice and
Bob computed the same shared secret.
